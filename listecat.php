                        ...
                        <?php
                               foreach($categories as $categorie){
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                   <a data-toggle="modal" data-target="#editModal'.$categorie['idcat'].'" class= btn btn-success">Modifier</a>
                                   <a onClick ="return popUpDeleteCategorie()" href="supprimer.php?idc='.$categorie['idcat'].'"class= btn btn-danger">Supprimer</a>
                                    </td>
      ...
      <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="ajout.php" method="post" id="addform">
                      <div class="form-group" id="blocknom">
                        <label for="exampleInputName1">Nom de categorie </label>
                        <input type="text" name="nomcat" id="nomcat" class="form-control" id="exampleInputName1" placeholder="Nom" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputCity1">ID de categorie</label>
                        <input type="text" name="idcat" class="form-control" id="exampleInputCity1" placeholder="ID" disabled />
                      </div>
...
foreach($categories as $categorie){?>
<!-- Modal Modifier-->
<div class="modal fade" id="editModal<?php echo $categorie['idcat'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="modifier.php" method="post" >
                      <input type="hidden" value="<?php echo $categorie['idcat']; ?>" name="idc"/>
                      <div class="form-group" >
                        <label for="exampleInputName1">Nom de categorie </label>
                        <input type="text" name="nomcat"  class="form-control" value="<?php echo $categorie['nomcat'] ?>" id="exampleInputName1" placeholder="Nom" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputCity1">ID de categorie</label>
                        <input type="text" name="idcat" class="form-control" value="<?php echo $categorie['idcat'] ?>" id="exampleInputCity1" placeholder="ID" disabled/>
                      </div>
                      <button type="submit" class="btn btn-primary mr-2"> Submit </button>
                      <button class="btn btn-light">Cancel</button>
                    </form>
...
?>
    ...
    $('#addform').sumbit(function(){
      if ($('#nomcat').val()==""){
        $('#blocknom').append('<p>Il faut remplir le champ nom </p>');
        return false;
      }
    })
    </script>
