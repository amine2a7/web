                      ...
                      <table class="table table-bordered">
                                  ...
                                  if(!$con)
                                  {
                                    die("probleme de connexion".mysqli_connect_error());
                                      ...
                                      $sql="SELECT * FROM produits ORDER BY nomprod";
                                   ...
                                   echo "Reference : " .$row["ref"].   "<br/>Prix : ".$row["prix"]. "<br/>Nom de produit : ".$row["nomprod"]. "<br/> Descption : ".$row["descprod"]. "<br/>Id de categorie : ".$row["idcat"]. "<br/><br/><br/>";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="ajoutprod.php" method="post" enctype="multipart/form-data" >
                      ...
                      <div class="form-group" >
                        ...
                        <input type="number" name="reference" class="form-control" id="exampleInputName1" placeholder="Nom" />
                      </div>
                      <div class="form-group">
